...
function formatLabel(rangeKey, dateRange) {
...
export default function Dashboard2DateRange({ rangeKey, dateRange, onPresetChange, onCustomChange }) {
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="outline" className="h-9 text-xs font-normal gap-2" dir="rtl">
          <CalendarIcon className="h-4 w-4" />
          <span>{formatLabel(rangeKey, dateRange)}</span>
        </Button>
      </PopoverTrigger>
