    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="bg-white border w-full h-auto flex-wrap justify-start">
          <TabsTrigger value="all">הכל ({factoryOrders.length})</TabsTrigger>
          <TabsTrigger value="queue">תור ({queueCount})</TabsTrigger>
          <TabsTrigger value="in_production">בייצור ({inProductionCount})</TabsTrigger>
          <TabsTrigger value="ready">מוכן ({readyCount})</TabsTrigger>
