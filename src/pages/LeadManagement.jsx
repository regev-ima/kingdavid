...
import {
  ...
  Moon, Sun, Hourglass, Phone, FileText, ShoppingCart, MessageCircle,
} from 'lucide-react';
import { startOfDay, endOfDay, startOfWeek, startOfMonth, format } from '@/lib/safe-date-fns';
import { toZonedTime, fromZonedTime, formatInTimeZone } from '@/lib/safe-date-fns-tz';
import { useImpersonation } from '@/components/shared/ImpersonationContext';
import { canAccessSalesWorkspace, isFactoryUser } from '@/components/shared/rbac';
import { useCustomStatuses } from '@/hooks/useCustomStatuses';
import { LEAD_STATUS_OPTIONS, LEAD_SOURCE_OPTIONS, SOURCE_LABELS, CLOSED_STATUSES, TIMEZONE, SLA_THRESHOLDS, ALL_TASK_TYPE_LABELS } from '@/constants/leadOptions';
...
function LeadTable({ leads, isLoading, isAdmin, selectedLeads, onSelectionChange, repNameByEmail, onRowClick, highlightId }) {
  ...
  // Mirrors the Leads page: one batched fetch for the loaded rows, kept to the
  // earliest open task per lead.
